...
void LTexture::setColorHSV( double hue, double saturation, double value )
{
...
void LTexture::render( int x, int y, SDL_Rect* clip, double angle, double scale, SDL_Point* center, SDL_RendererFlip flip )
{
